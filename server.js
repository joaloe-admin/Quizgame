...
// ── COPPIE DI PAROLE PER TROVA LA TALPA ─────────────────────────────────────
const TALPA_WORDS = [
  ["Gatto","Tigre"], ["Cane","Lupo"], ["Cavallo","Zebra"], ["Leone","Puma"],
  ["Delfino","Squalo"], ["Pinguino","Cormorano"], ["Aquila","Falco"],
  ["Elefante","Rinoceronte"], ["Giraffa","Cammello"], ["Orso","Cinghiale"],
  ["Farfalla","Falena"], ["Ape","Vespa"], ["Coniglio","Lepre"],
  ["Mucca","Bufala"], ["Maiale","Cinghiale"], ["Gallina","Fagiana"],
  ["Pappagallo","Corvo"], ["Serpente","Lucertola"], ["Tartaruga","Iguana"],
  ["Balena","Delfino"], ["Granchio","Aragosta"], ["Polpo","Calamaro"],
  ["Coccodrillo","Varano"], ["Fenicottero","Airone"], ["Gorilla","Scimpanzé"],
  ["Pizza","Focaccia"], ["Pasta","Gnocchi"], ["Gelato","Sorbetto"],
  ["Caffè","Tè"], ["Pane","Grissino"], ["Bistecca","Costoletta"],
  ["Salmone","Tonno"], ["Tiramisù","Zuppa inglese"], ["Risotto","Pilaf"],
  ["Mozzarella","Burrata"], ["Prosciutto","Bresaola"], ["Vino","Birra"],
  ["Cioccolato","Caramella"], ["Fragola","Lampone"], ["Banana","Mango"],
  ["Arancia","Mandarino"], ["Mela","Pera"], ["Uva","Fico"],
  ["Pomodoro","Peperone"], ["Cipolla","Aglio"], ["Patata","Rapa"],
  ["Spaghetti","Linguine"], ["Lasagne","Cannelloni"], ["Ravioli","Tortellini"],
  ["Cappuccino","Macchiato"], ["Cornetto","Brioche"], ["Biscotto","Wafer"],
  ["Calcio","Rugby"], ["Tennis","Badminton"], ["Nuoto","Pallanuoto"],
  ["Ciclismo","Triathlon"], ["Pallavolo","Pallacanestro"], ["Sci","Snowboard"],
  ["Golf","Croquet"], ["Boxe","Karate"], ["Corsa","Marcia"],
  ["Ginnastica","Acrobatica"], ["Scherma","Tiro con l arco"],
  ["Canottaggio","Kayak"], ["Surf","Windsurf"], ["Atletica","Decathlon"],
  ["Divano","Poltrona"], ["Letto","Amaca"], ["Lampada","Candela"],
  ["Specchio","Quadro"], ["Tappeto","Zerbino"], ["Tenda","Persiana"],
  ["Armadio","Cassettone"], ["Frigorifero","Congelatore"],
  ["Forno","Microonde"], ["Lavatrice","Lavastoviglie"],
  ["Tavolo","Scrivania"], ["Sedia","Sgabello"], ["Cuscino","Coperta"],
  ["Spiaggia","Scogliera"], ["Montagna","Collina"], ["Foresta","Giungla"],
  ["Lago","Stagno"], ["Fiume","Torrente"], ["Deserto","Savana"],
  ["Vulcano","Geyser"], ["Cascata","Sorgente"], ["Isola","Penisola"],
  ["Prato","Campo"], ["Giardino","Parco"], ["Grotta","Miniera"],
  ["Neve","Grandine"], ["Temporale","Nebbia"], ["Arcobaleno","Aurora boreale"],
  ["Medico","Infermiere"], ["Insegnante","Professore"], ["Pompiere","Poliziotto"],
  ["Cuoco","Pasticcere"], ["Pilota","Astronauta"], ["Attore","Cantante"],
  ["Avvocato","Giudice"], ["Architetto","Ingegnere"], ["Fotografo","Pittore"],
  ["Meccanico","Idraulico"], ["Elettricista","Tecnico"], ["Barista","Cameriere"],
  ["Automobile","Camion"], ["Moto","Scooter"], ["Bicicletta","Monopattino"],
  ["Treno","Tram"], ["Aereo","Elicottero"], ["Nave","Traghetto"],
  ["Bus","Pullman"], ["Taxi","Ambulanza"], ["Sottomarino","Sommergibile"],
  ["Scarpe","Stivali"], ["Cappello","Berretto"], ["Giacca","Cappotto"],
  ["Jeans","Pantaloni"], ["Vestito","Gonna"], ["Camicia","T-shirt"],
  ["Cintura","Bretelle"], ["Orecchini","Collana"], ["Anello","Bracciale"],
  ["Borsa","Zaino"], ["Occhiali","Lente a contatto"], ["Guanti","Muffole"],
  ["Chitarra","Basso"], ["Pianoforte","Organo"], ["Violino","Viola"],
  ["Batteria","Bonghi"], ["Flauto","Clarinetto"], ["Tromba","Trombone"],
  ["Arpa","Mandolino"], ["Sassofono","Oboe"],
  ["Smartphone","Tablet"], ["Computer","Laptop"], ["Televisione","Monitor"],
  ["Cuffie","Auricolari"], ["Fotocamera","Webcam"], ["Stampante","Scanner"],
  ["Router","Modem"], ["Tastiera","Mouse"],
  ["Cinema","Teatro"], ["Cartone animato","Film d animazione"],
  ["Commedia","Satira"], ["Horror","Thriller"], ["Fumetto","Manga"],
  ["Videogioco","Gioco da tavolo"], ["Libro","Romanzo"], ["Podcast","Radio"],
  ["Ospedale","Clinica"], ["Scuola","Università"], ["Chiesa","Cattedrale"],
  ["Museo","Galleria"], ["Ristorante","Trattoria"], ["Hotel","Ostello"],
  ["Supermercato","Mercato"], ["Banca","Posta"], ["Farmacia","Erboristeria"],
  ["Stadio","Palazzetto"], ["Teatro","Opera"], ["Piscina","Spa"],
  ["Natale","Epifania"], ["Capodanno","Carnevale"], ["Pasqua","Ferragosto"],
  ["Compleanno","Anniversario"], ["Matrimonio","Fidanzamento"],
  ["Laurea","Diploma"], ["Halloween","Carnevale"],
  ["Felicità","Euforia"], ["Tristezza","Malinconia"], ["Rabbia","Frustrazione"],
  ["Paura","Ansia"], ["Sorpresa","Stupore"], ["Amore","Passione"],
  ["Noia","Indifferenza"], ["Nostalgia","Rimpianto"],
  ["Rosso","Bordeaux"], ["Blu","Azzurro"], ["Verde","Smeraldo"],
  ["Giallo","Oro"], ["Bianco","Avorio"], ["Nero","Grigio scuro"],
  ["Rosa","Fucsia"], ["Viola","Lilla"], ["Arancione","Ambra"],
  ["Supereroe","Vigilante"], ["Mago","Stregone"], ["Robot","Androide"],
  ["Drago","Dinosauro"], ["Unicorno","Pegaso"], ["Zombie","Vampiro"],
  ["Alieno","Mutante"], ["Ninja","Samurai"], ["Pirata","Corsaro"],
];
...
// ── PROXY MIDI ───────────────────────────────────────────────────────────────
// ── MIDI PROXY con AWS SDK S3 ───────────────────────────────────────────────
const { S3Client, GetObjectCommand } = require('@aws-sdk/client-s3');
const s3client = new S3Client({
  region: 'eu2',
  endpoint: 'https://eu2.contabostorage.com',
  credentials: {
    accessKeyId:     '007fc270449299fbae0b592feb85ad39',
    secretAccessKey: '871768234f4016e3efd6ab9ca77cf186',
  },
  forcePathStyle: true,
});
...
app.get('/midi/*', async (req, res) => {
  ...
  const key = 'midi/' + decodeURIComponent(midiPath);
  console.log('MIDI proxy:', key);
  try {
    const cmd = new GetObjectCommand({ Bucket: 'storage', Key: key });
    ...
    console.error('MIDI S3 error:', e.message, key);
    res.status(404).send('MIDI not found: ' + e.message);
  }
});
